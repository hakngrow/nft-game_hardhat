...
contract EpicGame is ERC721 {
    // Store a character's attributes in a struct.
    ...
    // Array to hold the default data for characters.
    CharacterAttributes[] defaultCharacters;

    // Mapping from the NFT's tokenId => NFT's attributes.
    mapping(uint256 => CharacterAttributes) public nftHolderAttributes;

    // Mapping from an owner address => the NFTs tokenId
    ...
    // Data passed in to the contract when first created initializing the characters.
    constructor(
        ...
        // Initialize the global "bigBoss" state variable.
        bigBoss = BigBoss({
            name: bossName,
        ...
        // they can be used when minting the NFTs
